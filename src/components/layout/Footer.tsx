      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
        ...
        <div className="space-y-4 flex flex-col justify-between">
          <div>
            ...
            <div className="flex flex-col space-y-2 text-sm font-mono text-secondary mt-4">
          ...
          <div className="pt-4">
            <h4 className="font-display text-sm tracking-widest text-white/50 uppercase mb-4">Connect</h4>
            <div className="flex items-center gap-5 text-secondary">
              {/* Facebook */}
              <a href="https://www.facebook.com/TheMediaMafias" target="_blank" rel="noopener noreferrer" className="hover:text-red-accent transition-all hover:scale-110">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* Instagram */}
              <a href="https://www.instagram.com/mediamafias" target="_blank" rel="noopener noreferrer" className="hover:text-red-accent transition-all hover:scale-110">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/mediamafias" target="_blank" rel="noopener noreferrer" className="hover:text-red-accent transition-all hover:scale-110">
